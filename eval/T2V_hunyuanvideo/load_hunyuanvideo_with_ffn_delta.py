"""
Load HunyuanVideo-1.5 T2V, apply multi-layer FFN delta patch,
run UniErase-Bench T2V.
...
BENCHMARK_PATH = SCRIPT_DIR / "../../prompt_data/UniErase-Bench/t2v_benchmark.jsonl"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Load HunyuanVideo T2V pipeline, apply a saved multi-layer FFN delta "
            "patch, and evaluate on UniErase-Bench T2V."
        )
    )
